...
| Field                   | Description                                                    |
|-------------------------|----------------------------------------------------------------|
| `schemaLocation[]`      | Schema URLs, file paths, or templates tried in order. The `ecosystem` alias points at [schemas.fluxoperator.dev](https://schemas.fluxoperator.dev/); `default` is not supported by `explain`. |
